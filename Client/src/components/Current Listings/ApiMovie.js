        ...
        <div className="col s6 m4 l3">
            <div className="card">
                ...
                <div className="card-content">
                    <span className="card-title grey-text text-darken-4" style={{height: 80, fontSize: 17}}>{props.title} <img src="{props.ageIcon}"/> <i className="material-icons right"></i></span>
